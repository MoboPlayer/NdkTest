...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=./android/armv7_neon --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/data/dev_tools/android-ndk/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/data/dev_tools/android-ndk/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86/bin/ --nm=/data/dev_tools/android-ndk/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86/bin/arm-linux-androideabi-nm --ar=/data/dev_tools/android-ndk/android-ndk-r7/toolchains/arm-linux-androideabi-4.4.3/prebuilt/darwin-x86/bin/arm-linux-androideabi-ar --sysroot=/data/dev_tools/android-ndk/android-ndk-r7/platforms/android-14/arch-arm --extra-cflags=' -O3 -w -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -Wno-error=return-type -fno-short-enums -fno-strict-aliasing -finline-limit=300 -ftree-vectorize -mvectorize-with-neon-quad -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 ' --disable-shared --enable-static --extra-ldflags='-Wl,-rpath-link=/data/dev_tools/android-ndk/android-ndk-r7/platforms/android-14/arch-arm/usr/lib -L/data/dev_tools/android-ndk/android-ndk-r7/platforms/android-14/arch-arm/usr/lib -nostdlib -lc -lm -ldl -llog' --disable-everything --enable-protocol=file --enable-protocol=http --enable-protocol=https --enable-protocol=hls --enable-demuxer=mov --enable-demuxer=matroska --enable-muxer=mov --enable-muxer=matroska --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=ac3 --enable-decoder=aac --enable-decoder=amrnb --enable-decoder=amrwb --enable-encoder=h264 --enable-encoder=mpeg4 --enable-encoder=ac3 --enable-encoder=aac --enable-parser=h264 --enable-small --enable-network --enable-asm --enable-pthreads --disable-debug --enable-swscale --disable-ffplay --disable-swscale-alpha --disable-ffprobe --disable-ffserver --disable-indevs --disable-bsfs --disable-filters --disable-gpl --disable-devices --disable-postproc --disable-avdevice --disable-avfilter --disable-filters --disable-doc --enable-neon"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "./android/armv7_neon/share/ffmpeg"
#define AVCONV_DATADIR "./android/armv7_neon/share/ffmpeg"
